...
1. Unduh Binary LiveKit Server:
   ...
   - Unduh file kompresi server yang sesuai dengan OS Anda (misal: `livekit-server_Windows_x86_64.zip` untuk Windows atau `livekit-server_Linux_x86_64.tar.gz` meper `livekit-server_Linux_x86_64.tar.gz` untuk Linux).
2. Ekstrak File:
