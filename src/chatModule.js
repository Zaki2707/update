...
// Evaluasi already owns a throttled server snapshot. Pause the generic SSE sync while
// this tab is open so activeExamSessions invalidations from a busy CBT room cannot
// fan out tenant-wide monitoring snapshots and starve Preview/Koreksi requests.
(() => {
  const CHECK_MS = 750;
